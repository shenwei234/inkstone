...
func main() {
	...
	authHandler := handler.NewAuthHandler(authSvc, emailCodeSvc, apiLimiter, logSvc)
	...
	commentHandler := handler.NewCommentHandler(commentSvc, tokens, apiLimiter)
	...
	settingsHandler := handler.NewSettingsHandler(settingsSvc, mailer, emailCodeSvc)
